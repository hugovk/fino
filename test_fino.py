...
class TestIt(unittest.TestCase):
    ...
    def test_miljardi(self) -> None:
        number = 10**9
        word = fino.to_finnish(number)
        self.assertEqual(word, "miljardi")

    def test_1234567890(self) -> None:
    ...
    def test_287654321004(self) -> None:
